...
def mapping_time_to_event(exel_file_path: str,output_df: pd.DataFrame) -> pd.DataFrame:
    """
    ...
    exel_verlauf_df = pd.read_excel(exel_file_path, sheet_name="Verlauf", usecols="A:BH")
    ...
    mapping_df = pd.read_csv("mapping_csvs/time_to_event_measures.csv")
    # map the data
